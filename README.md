...
Note: it is up to the user to implement a bridge which connects its Receding Horizon Controller with MPCViz. By default, MPCViz uses some naming conventions for its *bridge* topics, defined in `utils/namings.py`. 
